...
export default function ControlPanel({
  ...
  return (
    <div className="fixed top-4 right-4 bg-gradient-to-br from-gray-900/95 to-black/95 backdrop-blur-xl rounded-2xl p-6 shadow-2xl border border-white/10 z-50 min-w-80 animate-in slide-in-from-right duration-300">
